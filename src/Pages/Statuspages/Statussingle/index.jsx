    ...
    <div className="col-md center-main">
      ...
      <div className="d-flex cheel-apartment mt-5">
        ...
        <div className=" d-felx cheels ">
          ...
          <div className="d-flex gap-1 mt-5 cheelsecond">
            <div className="best-tutorial ms-2">
      ...
      <div className="d-flex gap-2 burger-main">
        <div className="card  burger-1">
          <div className="burger  mt-2"></div>
          <div className="card-body burger-detail ">
        ...
        <div className="d-flex cardpack">
          <div className="card" style={{ width: "17rem", height: "10rem" }}>
            <img
              src="../images/product-1.jpg"
              className="card-img-top"
              alt="..."
            />
            <div className="d-flex product mt-2">
              <span className="baby">Baby Products</span>
