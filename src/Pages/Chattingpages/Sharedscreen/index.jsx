...
const Sharedscreen = () => {
  ...
  <div className="height-main">
      ...
      <button className="btn btn-profile-2 text-light " htmlFor="#">
        Update Profile
      </button>

    <div className="marina-ojok text-center d-flex">
      <img src="../images/icons/Vector7.png" className="img-ojok ms-2" alt="" />
    ...
    <div className="visit-image-2">
      ...
      <button className="btn btn-container-2 text-light" htmlFor="#">
        Update Cover
      </button>
  </div>
  <div className="additional-info mt-5">
    <div className="cheelbase d-flex justify-content-end">
      ...
      <div className=" col-md-3 img-size account-category mt-1 d-flex">
        <img
  ...
  <div className="professional-experience d-flex">
  ...
  <div className="main-address">
    <div className="address-info mt-4 d-flex">
      <div className=" col-6 address d-flex">
        <img
          src="../images/icons/home_pin.png"
          className="img-size mt-1"
          alt=""
        />
        <h5 className="london">Ruislip, Greater London</h5>
        <img
          src="../images/icons/visibility_lock.png"
  ...
  <hr className="hr-line" />
  <div className="website-link d-flex mt-4 justify-content-between align-items-center">
  ...
  <div className="row img-sizing mt-5">
    <div className="col-lg-2 width-col2">
      <img
